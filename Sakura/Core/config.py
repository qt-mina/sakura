...
START_STICKERS_PACK = os.getenv("START_STICKERS_PACK", "https://t.me/addstickers/Umaru_un")
PAYMENT_STICKERS_PACK = os.getenv("PAYMENT_STICKERS_PACK", "https://t.me/addstickers/Umaru_un")
